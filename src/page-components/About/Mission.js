      ...
      <Box>
          ...
          <ul>
            <li>
              <Typography>
                ...
                regarded as the most trusted source of information by core units
                and the DeFi community as a whole.
              </Typography>
            </li>
            ...
            <li>
              Exceptionally clear and concise content, accomplished by following
              the highest standards of communication and pedagogy, will allow
              users to rapidly grow their knowledge and compress their learning
              curve.
            </li>
          </ul>
        </>
          ...
          <ul>
            <li>
              <Typography>
                ...
                learners to create a funnel into the onboarding process for the
                incubation program, core unit teams, the grants program, and
                other ways of contribution towards MakerDAO.
              </Typography>
            </li>

            <li>
              Through working with core units to establish onboarding material,
              Maker Academy will rapidly turn new hires into contributors that
              are integrated with their team and work.
            </li>
          </ul>
        </>
        ...
        <>
          ...
          <ul>
            <li>
              <Typography>
                Through the continuous analysis of MakerDAO required to produce
                educational content, Maker Academy will be a large source of
                producing research questions for all kinds of contributors to
                investigate.
              </Typography>
            </li>

            <li>
              Maker Academy will assist core units with their work by formatting
              it into clearly defined projects, such as bounties or grant
              projects, that Maker Academy's learners can complete as a part of
              their education.
            </li>
          </ul>
        </>
        ...
        <>
          ...
          <ul>
            <li>
              <Typography>
                Maker Academy will encourage knowledge sharing amongst the core
                units in order to aggregate their documentation, new
                discoveries, and other relevant information in one easy to find
                place.
              </Typography>
            </li>
          </ul>
          ...
          <ol>
            <li>
              <Typography sx={{ "& span": { fontWeight: 500 } }}>
                <span>Challenge:</span> Other core unit's have the power to lack
                or neglect communication with Maker Academy as a result of the
                ...
                Maker Academy will incentivize core units to communicate with it
                through adding more contribution projects for learners that
            ...
            <li>
              <Typography sx={{ "& span": { fontWeight: 500 } }}>
                <span>Challenge:</span> There is constant and rapid evolution of
                both the technology and the ideas behind MakerDAO and DeFi.
                <br />
                <span>Effect:</span> Maker Academy's content may become outdated
                and even incorrect
                <br />
                <span>Solution:</span> Maker Academy will have a large community
                of content producers with a quick process of making corrections
                to content. Additionally, educational content will be designed
                in a way where principles are more emphasized than applications
                of those principles (this is how to build a car VS this is how
                Tesla builds cars). This lowers the chances of producing content
                at risk of becoming outdated. However, concretes/applications
                are necessary sometimes, and, as a result, they will cleary be
                identified as being subject to change.
              </Typography>
            </li>
            ...
            <li>
              <Typography sx={{ "& span": { fontWeight: 500 } }}>
                ...
                of other core units after conducting its own analysis, to ensure
                as correct prioritization as possible.
              </Typography>
            </li>
